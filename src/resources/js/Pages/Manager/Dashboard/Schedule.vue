				...
				<section aria-labelledby="timeline-title" class="lg:col-start-3 lg:col-span-1">
					<div class="bg-white px-3 py-5 shadow sm:rounded-lg">
						...
						<div class="mt-6 flex flex-col justify-stretch">
							<a type="button" :href="route('orders.create')" class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Nuevo Pedido</a>
						</div>
					</div>
				</section>
			</div>
