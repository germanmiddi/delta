                        ...
                        <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-md">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <Datepicker id="fecha_fin" class="w-full mt-1" v-model="form.fecha_retiro" 
                                                :enableTimePicker="false"
                                                :monthChangeOnScroll="false" 
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-4">
                                    ...
                                    <select v-model="form.driver_id" id="driver" name="driver"  
                                        ...
                                        <option v-for="driver in drivers" :key="driver.id" :value="driver.id" :bind:select="driver.id == form.driver_id">{{driver.fullname}}</option>
                                    </select>
                                 </div>                            
                            </div>    
                                ...
                                <div class="col-span-4">
                                    <label for="client" class="block text-sm font-medium text-gray-700">Seleccione un cliente existente:</label>
                                        <select id="client" name="client" v-model="form.client_id" 
                                            ...
                                            <option v-for="client in this.clients" :key="client.id" :value="client.id" :bind:select="client.id == form.client_id">{{client.fullname}} - {{client.street}} {{client.strnum}} {{client.city_ltxt}}</option>
                                        </select>
                                 </div>
...
<div class="col-span-4">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select id="company" name="company" v-model="form.company_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" disabled>
                                                <option disabled value="">Seleccione una empresa</option>
                                                <option v-for="empresa in this.empresas" :key="empresa.id" :value="empresa.id" :bind:select="empresa.id == form.company_id">{{empresa.razon_social}}</option>
                                            </select>                                    
                                </div>
...
<script>
    ...
    export default defineComponent({
        ...
        methods:{
            ...
            formatHora(){
                this.form.hora_inicio = { hours: moment(this.form.hora_inicio,'HH:mm:ss').format('H'), minutes: moment(this.form.hora_inicio,'HH:mm:ss').format('mm') };
                this.form.hora_retiro = { hours: moment(this.form.hora_retiro,'HH:mm:ss').format('H'), minutes: moment(this.form.hora_retiro,'HH:mm:ss').format('mm') };
