                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="fecha_fin" class="block text-sm font-medium text-gray-700">Hora
                                        Fin:</label>
                                    <Datepicker id="fecha_fin" class="w-full mt-1" v-model="form.hora_retiro"
                                        :startTime="startTime" timePicker></Datepicker>
                                </div>
                                ...
                                <div class="col-span-4">
                                    ...
                                    <select id="client" name="client" v-model="form.client_id"
                                        ...
                                        <option v-for="client in this.clients" :key="client.id" :value="client.id"
                                            :bind:select="client.id == form.client_id">{{ client.fullname }} -
                                            {{ client.street }} {{ client.strnum }} {{ client.city_ltxt }}</option>
                                    </select>
                                </div>
