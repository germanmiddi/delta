                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('orders')" :active="route().current('orders')">
                                    Pedidos
                                </JetNavLink>
                                <JetNavLink :href="route('clients')" :active="route().current('clientes')">
                                    Clientes
                                </JetNavLink>
                                <JetNavLink :href="route('companies')" :active="route().current('companies')">
                                    Empresas
                                </JetNavLink>
